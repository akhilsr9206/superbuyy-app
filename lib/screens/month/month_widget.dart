...
class MonthlistWidget extends StatefulWidget {
  const MonthlistWidget({Key? key, required this.q}) : super(key: key);
  final int q;

  @override
  State<MonthlistWidget> createState() => _MonthlistWidgetState();
}
...
class _MonthlistWidgetState extends State<MonthlistWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    bool? _isInMonthlist =
        monthlistProvider.getMonthlistItems.containsKey(getCurrentProduct.id);
    bool? _isInWishlist =
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, ProductDetails.routeName,
            arguments: monthlistModel.productId);
      },
      child: Row(
        children: [
          Expanded(
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              _quantityController(
                                fct: () {
                                  if (_quantityTextController.text == '1') {
                                    ...
                                    monthlistProvider.reduceQuantityByOne(
                                        monthlistModel.productId);
                                    setState(() {
                              ...
                              _quantityController(
                                fct: () {
                                  monthlistProvider.increaseQuantityByOne(
                                      monthlistModel.productId);
                                  setState(() {
                                    _quantityTextController.text = (int.parse(
